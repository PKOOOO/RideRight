...
export type Product = {
  ...
  origin?: "locally_used" | "imported" | "foreign_used_in_stock" | "foreign_used_soon_arriving";
  location?: string;
  mileage?: number;
  horsePower?: number;
  torque?: number;
...
// Query: *[  _type == "product"] | order(name asc) {  _id,  name,  "slug": slug.current,  description[]{  ...,  _type == "block" => {    ...,    children[]{...}  }},  price,  originalPrice,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  year,  fuelType,  engine,  transmission,  origin,  location,  mileage,  horsePower,  torque,  stock,  featured}
export type ALL_PRODUCTS_QUERYResult = Array<{
  ...
  origin: "foreign_used_in_stock" | "foreign_used_soon_arriving" | "imported" | "locally_used" | null;
...
// Query: *[  _type == "product"  && slug.current == $slug][0] {  _id,  name,  "slug": slug.current,  description[]{    ...,    _type == "block" => {      ...,      children[]{...}    }  },  price,  originalPrice,  "images": images[]{    _key,    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  year,  fuelType,  engine,  transmission,  origin,  location,  mileage,  horsePower,  torque,  stock,  featured}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($fuelType == "" || fuelType == $fuelType)  && ($transmission == "" || transmission == $transmission)  && ($origin == "" || origin == $origin || ($origin == "foreign_used" && origin in ["foreign_used_in_stock", "foreign_used_soon_arriving"]))  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*" || category->title match $searchQuery + "*")  && ($inStock == false || stock > 0)  && ($model == "" || model == $model)] | order(price desc) {  _id,  name,  model,  "slug": slug.current,  price,  originalPrice,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  year,  fuelType,  engine,  transmission,  origin,  location,  mileage,  horsePower,  torque,  stock}
...
// Query: *[  _type == "product"  && (    $searchQuery == ""    || name match $searchQuery + "*"    || description match $searchQuery + "*"    || category->title match $searchQuery + "*"  )  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($fuelType == "" || fuelType == $fuelType)  && ($transmission == "" || transmission == $transmission)  && ($origin == "" || origin == $origin || ($origin == "foreign_used" && origin in ["foreign_used_in_stock", "foreign_used_soon_arriving"]))  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)] | order(year desc, name asc) [0...20] {  _id,  name,  "slug": slug.current,  description,  price,  "image": images[0]{    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  year,  fuelType,  engine,  transmission,  origin,  location,  mileage,  horsePower,  torque,  stock,  featured}
...
// Variable: MODELS_BY_CATEGORY_QUERY
// Query: *[_type == "product" && category->slug.current == $categorySlug && defined(model)] {    "model": model  } | order(model asc)
export type MODELS_BY_CATEGORY_QUERYResult = Array<{
  model: string | null;
}>;
