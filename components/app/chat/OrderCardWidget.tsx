...
export function OrderCardWidget({ order, onClose }: OrderCardWidgetProps) {
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <span className="block truncate text-sm font-medium text-zinc-900 transition-colors duration-200 group-hover:text-red-600 dark:text-zinc-100 dark:group-hover:text-red-400">
  ...
  const cardClasses =
    "group flex items-center gap-3 rounded-lg border border-zinc-200 bg-white p-3 transition-all duration-200 hover:border-red-300 hover:shadow-md hover:shadow-red-100/50 dark:border-zinc-700 dark:bg-zinc-800/50 dark:hover:border-red-600/50 dark:hover:shadow-red-900/20";
